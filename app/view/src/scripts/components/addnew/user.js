...
export default class AddUser extends React.Component {
    ...
    resetForm = (e) => this.setState({ name: "", password: "", firstname: "", lastname: "", useremail: "", group: "notech", notes: "" });
    ...
    handleSubmit(e) {
        ...
        axios.post(url + '/users/create.php', formData)
                ...
                <div className="edit-form login">
                    <div className="edit-form__container">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <input type="submit" className="btn btn-default btn-submit" value="Add New" />
                        </form>
                    </div>
                </div>
            </div>
